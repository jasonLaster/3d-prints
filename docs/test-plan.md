...
| Parameter Limits | Static limits plus dependent holder tube/diameter limits, tray floor/height limits, compact-bracket source-section minimums and two-up plate envelope, metric-nut-knob bore/pocket/guard/handle wall and roof constraints, and Hover-table widened overhang/spread/support ranges, independent top/bottom box radii, six support-layout combinations, radius-aware placement, round-overs, conditional half-laps, and direct-contact relationships. |
