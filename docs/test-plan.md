...
| Workspace Inspector | Collapsible/resizable behavior, logically grouped X-Hover Overall/Tabletop/End boxes/Support layout/Top support members/Bottom support members/Support joinery/Routing templates controls, semantic top/bottom support selectors, weighted-center controls only for paper towel holder, router-mortise and router-tenon preset markers plus M5 hardware summaries, X-Hover Assembled/Exploded/Cut List/Templates modes, rendering modes, original overlay, and audit rows. |
