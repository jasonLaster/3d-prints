...
Each printed bracket has a 52 × 7 mm M6 slot. The bracket feet slide fore/aft over two fixed M6 screw-in inserts in the wood base. With the default 90 mm foot, the insert station centers the 55 mm fence setback and provides 45 mm of usable continuous travel.
...
Each bracket combines a 58 × 90 × 10 mm slotted foot, a 10 mm rear plate as tall as the fence, and two triangular 5 mm gussets. The bracket prints foot-down with the back upright. The 7.2 mm horizontal insert-pocket bridge remains below the configured 8 mm support-free screen.
...
Four individual, current-parameter STL files are generated: left bracket, right bracket, left lock knob, and right lock knob. Every file must contain finite nondegenerate triangles, be watertight/manifold under the repository topology check, and rest on Z=0 in its recommended print orientation.
