...
| Dining Table exports as a registered two-color STL set | Dining Table model JSON and `docs/dining-table-audit-specifications.md` | Playwright downloads and parses the wood color-1 and plate/C-channel hardware color-2 STLs, verifies finite nondegenerate triangles, and checks their shared coordinate registration |
