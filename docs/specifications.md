...
- Rounded tabletop and leg geometry, an optional post-top groove/rabbet with its top roundover moved below the recessed band, a separate bottom post roundover, four inset corner plates, and exactly three recessed C-channels are generated from numeric parameters.
